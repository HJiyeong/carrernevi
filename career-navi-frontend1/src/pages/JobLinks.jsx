            ...
            <div className="flex-1 relative px-10 pb-16 pt-24">
                ...
                <header className="fixed top-0 left-64 right-0 h-16 px-8 flex items-center justify-between bg-white/70 backdrop-blur border-b border-white/20 shadow z-50 rounded-bl-2xl">
                    ...
                    <nav className="flex gap-6 text-sm font-medium">
                        ...
                        <Link to="/chat" className="px-4 py-2 rounded-full bg-purple-600 text-white shadow hover:bg-purple-700 whitespace-nowrap">💬 AI커비와 상담하기</Link>
                    </nav>
                </header>
                            ...
                            {["전체", ...data.years.map((_, idx) => `STEP ${idx + 1}`)].map((label) => (
                                <button
                                    ...
                                    className={`px-4 py-1.5 rounded-full border ${
                                        filterStep === label ? "bg-purple-600 text-white" : "bg-white text-purple-700 border-purple-300"
                                    }`}
                    ...
                    {openMilestone && (
                        <>
                            ...
                            >
                                ...
                                {/* 닫기 버튼 */}
                                <button
                                    className="mt-auto px-4 py-2 rounded-full bg-purple-600 text-white hover:bg-purple-700 transition"
                                    onClick={() => setOpenMilestone(null)}
                                >
                                    닫기
                                </button>
