                ...
                <div className="flex gap-6">
                    ...
                    <div className="w-2/3 bg-white p-6 rounded-2xl shadow-md border border-gray-200">
                        ...
                        <button
                            ...
                            className="mt-4 bg-gradient-to-r from-purple-500 to-indigo-500 hover:opacity-90 text-white px-6 py-2 rounded-full font-semibold transition"
                        >
                            분석하기
                        </button>
                    </div>
                    ...
                    <div className="w-1/3 bg-white p-6 rounded-2xl shadow-md border border-gray-200">
                        ...
                        <button
                            ...
                            className="mb-6 w-full bg-gradient-to-r from-purple-700 to-indigo-600 text-white px-4 py-2 rounded-full font-semibold shadow hover:opacity-90 transition"
                        >
                            ✍️ 보완된 자기소개서 보기
                        </button>
