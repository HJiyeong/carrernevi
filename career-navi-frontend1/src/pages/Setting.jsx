        ...
        <div className="flex min-h-screen font-sans">
            ...
            <div className="flex-1 relative bg-gradient-to-br from-indigo-50 to-purple-100 pt-24 px-6 pb-20">
              ...
              <span className="text-2xl font-extrabold bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent">
                ...
                {/* 내용 */}
                <div className="max-w-4xl mx-auto bg-white border border-purple-200 rounded-3xl shadow p-10 space-y-10">
                    ...
                    <section>
                        ...
                        <div className="space-y-4">
                            ...
                            <button className="mt-4 px-4 py-2 rounded-full bg-purple-600 text-white hover:bg-purple-700 text-sm">
                                저장하기
                            </button>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="space-y-3">
                            ...
                            <button className="w-full px-4 py-2 rounded-xl bg-red-500 text-white text-sm hover:bg-red-600">
                                계정 영구 삭제
                            </button>
                        </div>
                    </section>
