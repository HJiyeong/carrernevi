      ...
      "
                ...
                <div className="max-w-7xl mx-auto space-y-10">
                    ...
                    <div className="flex justify-center gap-4">
                        <button onClick={() => setMode("sushi")} className={`px-6 py-2 rounded-full font-semibold shadow ${mode === "sushi" ? "bg-purple-600 text-white" : "bg-white text-purple-600 border"}`}>수시 성적표</button>
                        <button onClick={() => setMode("jungsi")} className={`px-6 py-2 rounded-full font-semibold shadow ${mode === "jungsi" ? "bg-purple-600 text-white" : "bg-white text-purple-600 border"}`}>정시 성적표</button>
                    </div>

                    <div className="flex flex-col xl:flex-row gap-6">
                        <div className="xl:w-1/2 w-full bg-white border border-purple-200 rounded-xl shadow p-6">
                            ...
                            />
                            {mode === "sushi" && (
                                <div className="mt-6 bg-purple-50 border border-purple-200 rounded-lg p-4 text-sm text-purple-800 whitespace-pre-line">
                            ...
                            {mode === "sushi" && (
                                <div className="mt-4 bg-white border border-purple-300 rounded-xl shadow p-4 space-y-3">
                                    ...
                                    <button
                                        ...
                                        className="text-left w-full px-4 py-2 bg-purple-50 border border-purple-200 rounded hover:bg-purple-100 font-medium text-purple-800"
                                    >
                                        📘 교과전형 추천 보기
                                    </button>
                                    {showGyogwa && (
                        ...
                        <div className="xl:w-1/2 w-full bg-white border border-purple-300 rounded-2xl shadow-xl overflow-hidden">
                            <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-100 to-indigo-100 border-b border-purple-200">
