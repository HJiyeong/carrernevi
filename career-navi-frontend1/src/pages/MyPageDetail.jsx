  ...
  "
      ...
      "
          ...
          <div className="max-w-6xl mx-auto space-y-14">
              ...
              {!editing ? (
                  <div className="flex-1">
                    ...
                    <button
                        ...
                        className="mt-3 px-4 py-1.5 text-xs rounded-full bg-purple-600 text-white hover:bg-purple-700"
                    >
                      정보 수정
                    </button>
                  </div>
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <div className="flex gap-2 mt-2">
                      <button onClick={()=>setEditing(false)}
                              className="px-4 py-1.5 bg-purple-600 text-white text-xs rounded-full hover:bg-purple-700">
                        저장
                      </button>
                      <button onClick={()=>setEditing(false)}
            ...
            {/* ② 성향 분석 */}
            <section className="bg-white border border-purple-200 rounded-3xl shadow p-8">
              ...
              {[
                ...
                ["나만의 포트폴리오 리포트","/diagnosis"],
                  ...
                  <button key={title} onClick={()=>navigate(to)}
                          className="bg-gradient-to-br from-blue-100 to-purple-100 border border-purple-200 p-6 rounded-2xl text-center shadow hover:shadow-lg hover:scale-105 transition">
