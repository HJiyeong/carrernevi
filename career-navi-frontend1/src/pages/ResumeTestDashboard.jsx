                ...
                <div className="max-w-5xl mx-auto space-y-10">
                    <div className="flex justify-between items-center">
                        ...
                        <button
                            ...
                            className="bg-gradient-to-br from-purple-500 to-indigo-500 hover:opacity-90 text-white px-5 py-2 rounded-xl font-bold shadow-lg transition duration-300"
                        >
                            + 새 문서 작성
                        </button>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {documents.length === 0 ? (
                            ...
                            <div className="col-span-2 flex flex-col items-center justify-center border border-dashed border-purple-300 rounded-2xl p-10 bg-purple-50 shadow-sm">
                                ...
                                <div className="bg-gradient-to-r from-purple-300 to-indigo-300 text-white font-semibold px-4 py-2 rounded-full shadow-md opacity-50 cursor-not-allowed">
                                    ✍️ 새 자기소개서 작성
                                </div>
                            </div>
                        ) : (
